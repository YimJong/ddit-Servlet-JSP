...
%>
<c:url var="registUserURI" value="/12/main.jsp">
	<c:param name="contextPage" value="/12/memberForm.jsp"></c:param>
</c:url>
	...
	$(function() {
		...
		if(Get_Cookie('mem_id')) {
		 ...
		 $('.loginBtn').on('click', function() {
			...
			const $form = $("<form action='${pageContext.request.contextPath}/12/loginCheck.jsp' method='post'> ");
