...
<body>
<form action="${pageContext.request.contextPath }/09/insertMemberInfo.jsp" name="memberForm" method="post">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td>
			<input type="text" name="mem_id" value="">&nbsp;&nbsp;<b><a id="idCheck" href="javascript:idCheck();">[ID 중복검사]</a></b>
		</td>
	</tr>
	<tr><td class="tLine" colspan="2"></td></tr>
...
<script>
	function idCheck() {
		...
		$.ajax({
			url : '${pageContext.request.contextPath}}/09/idCheck.jsp',
			data : { "mem_id" : mem_id },
			dataType : 'json',
	...
	function zipcodePopup() {
		...
		// 			          모달리스 : 출력되는 팝업에 존재해도 자유롭게 포커스가 이동이 가능.
		// Argument : 1. url
		//			  2. 팝업의 타이틀
		//			  3. 옵션(브라우저별 상이)
