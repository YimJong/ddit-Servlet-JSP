	...
	<div class="android-header mdl-layout__header mdl-layout__header--waterfall">
		<div class="mdl-layout__header-row">
			<span class="android-title mdl-layout-title"> 
				<a class="mdl-navigation__link mdl-typography--text-uppercase" href="<%=request.getContextPath()%>/10/main.jsp">
				<font color="yellow" style="font-size: 20px;">Stiftung DDIT</font></a>
			</span>
